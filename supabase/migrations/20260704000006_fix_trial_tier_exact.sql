-- Fix the assign_member_tier_exact trigger to properly allocate PRO to the self-audit account
...
BEGIN
  ...
  ELSIF v_auditor.tier = 'TRIAL' THEN
    -- In TRIAL, their self-account MUST get PRO. 
    -- If this is the self-account, give it PRO.
